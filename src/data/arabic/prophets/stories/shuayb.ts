...
const shuaybStoryContent: StoryContentBlock[] = [
  ...
  },
  {
    ...
    type: 'narrative',
    order: 42,
    content: "The daughter came 'walking with shyness' - a phrase that captures her modesty and noble character. The old man of Madyan wanted to reward Musa for his kindness. When Musa told him his story - how he had fled Egypt after killing a man - he reassured him: 'Fear not. You have escaped from the wrongdoing people.' Pharaoh's power did not reach Madyan. Musa was safe.",
    contentFr: "La fille vint « marchant avec pudeur », une expression qui traduit sa modestie et son noble caractère. Le vieil homme de Madyan voulait récompenser Moussa pour sa bonté. Lorsque Moussa lui raconta son histoire, comment il avait fui l'Égypte après avoir tué un homme, il le rassura : « Ne crains rien. Tu as échappé au peuple injuste. » Le pouvoir de Pharaon ne s'étendait pas à Madyan. Moussa était en sécurité.",
  },
  {
    id: 'shuayb-43',
    type: 'quran_source',
  ...
  },
  {
    ...
    type: 'narrative',
    order: 44,
    content: "The daughter's recommendation - 'the strong and the trustworthy' - became legendary. She recognised in Musa the two qualities essential for any task: strength to accomplish it and integrity to be trusted with it. Her father saw in Musa a worthy son-in-law and proposed marriage to one of his daughters, with eight to ten years of service as the mahr (dowry). Musa agreed.",
    contentFr: "La recommandation de la fille, « le fort et le digne de confiance », est devenue célèbre. Elle reconnut en Moussa les deux qualités essentielles à toute tâche : la force pour l'accomplir et l'intégrité pour qu'on la lui confie. Son père vit en Moussa un gendre digne et lui proposa d'épouser l'une de ses filles, avec huit à dix années de service comme mahr (dot). Moussa accepta.",
  },
  {
    id: 'shuayb-45',
    type: 'quran_source',
