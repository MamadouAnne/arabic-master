...
const dhulKiflStoryContent: StoryContentBlock[] = [
  ...
  },
  {
    ...
    type: 'narrative',
    order: 8,
    content: "There is a narration reported by Ibn Jarir at-Tabari from Mujahid - not a hadith of the Prophet ﷺ, and not of established authenticity - that speaks of a righteous man who succeeded Al-Yasa'. Before Al-Yasa' died, he sought someone to take his place - someone who would fast every day, pray all night, and never become angry. A young man accepted this 'kifl' (pledge) and fulfilled it faithfully, earning the name Dhul-Kifl.",
    contentFr: "Il existe un récit rapporté par Ibn Jarir at-Tabari d'après Mujahid, qui n'est pas un hadith du Prophète ﷺ et dont l'authenticité n'est pas établie, qui parle d'un homme pieux ayant succédé à Al-Yasa'. Avant de mourir, Al-Yasa' cherchait quelqu'un pour prendre sa place : quelqu'un qui jeûnerait chaque jour, prierait toute la nuit et ne se mettrait jamais en colère. Un jeune homme accepta ce « kifl » (engagement) et l'honora fidèlement, méritant le nom de Dhul-Kifl.",
  },
  {
    id: 'dhulkifl-9',
    type: 'narrative',
  ...
  },
  {
    ...
    type: 'narrative',
    order: 10,
    content: "One account describes how Shaytan appeared in the form of an old man seeking help with a dispute. He came three times, each time at the most inconvenient moment - once when Dhul-Kifl was about to sleep after a long night of prayer. Each time, Dhul-Kifl listened patiently without anger. When he finally realised the old man was Shaytan testing him, he remained steadfast. In this narration he is described as a righteous man; whether Dhul-Kifl was a prophet or a righteous servant is a matter scholars discussed, though Ibn Kathir held that the apparent meaning of the Quran - which lists him among the prophets - is that he was one.",
    contentFr: "Un récit décrit comment Shaytan apparut sous la forme d'un vieil homme cherchant de l'aide pour un différend. Il vint trois fois, chaque fois au moment le plus inopportun, dont une fois alors que Dhul-Kifl allait dormir après une longue nuit de prière. Chaque fois, Dhul-Kifl écouta patiemment sans colère. Lorsqu'il comprit enfin que le vieil homme était Shaytan qui le mettait à l'épreuve, il resta ferme. Dans ce récit, il est décrit comme un homme pieux ; la question de savoir si Dhul-Kifl était un prophète ou un serviteur pieux a été discutée par les savants, mais Ibn Kathir a considéré que le sens apparent du Coran, qui le cite parmi les prophètes, est qu'il en était un.",
  },
  {
    id: 'dhulkifl-11',
    type: 'narrative',
